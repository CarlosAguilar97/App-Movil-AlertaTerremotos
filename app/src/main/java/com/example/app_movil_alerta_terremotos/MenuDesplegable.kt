...
fun NavigationPage(NavegarLogin:()-> Unit) {
    ...
    ModalNavigationDrawer(
        ...
        androidx.compose.material3.Scaffold(topBar = {
            SmallTopAppBar(title = { androidx.compose.material3.Text(text = "Menu") }, navigationIcon = {
                ...
                IconButton(onClick = {
                    ...
                    androidx.compose.material3.Icon(Icons.Filled.Menu, contentDescription = "Drawer Menu.")
                }
